  ...
  return (
    <>
      {products && <div className=''>
        <ProductViewModal open={productModal} setOpen={setProductModal} productDetails={activeProduct} />
                ...
                <StyledTableRow key={product.name}>
                  ...
                  <StyledTableCell align='center'>
                    <div className='flex gap-2 items-center justify-center'>
                      <button className='border px-1 pr-2 py-1 flex items-center rounded-md  text-white bg-blue-600' style={{ gap: '1px' }} onClick={() => handleProductModal(product)}>
                        <AiFillEye className='text-white' style={{ color: 'white', fontSize: '14px' }} />
                        <span className='' >View</span>
                      </button>
                      <button className='border px-2 py-1 flex items-center rounded-md  bg-red-600 text-white' style={{ gap: '1px' }} onClick={() => productDelete(product._id)}>
