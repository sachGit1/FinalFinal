...
export const getAllOrders = () => async (dispatch) => {
  try {
    ...
    const orders = await axios({
      method: "GET",
      url: `https://localhost:4000/api/v1/order/provider`,
    });
...
export const getUserOrders = () => async (dispatch) => {
  try {
    ...
    const orders = await axios({
      method: "GET",
      url: "https://localhost:4000/api/v1/order/user",
    });
...
export const addOrder = (data) => async (dispatch) => {
  try {
    ...
    const order = await axios({
      method: "POST",
      url: `https://localhost:4000/api/v1/order`,
      data,
    });
...
export const updateOrder = (data) => async (dispatch) => {
  try {
    ...
    const order = await axios({
      method: "PUT",
      url: `https://localhost:4000/api/v1/order/updateStatus`,
      data,
    });
...
export const deleteOrder = (data) => async (dispatch) => {
  try {
    ...
    await axios({
      method: "DELETE",
      url: `https://localhost:4000/api/v1/order/${data.order._id}`,
    });
  } catch (error) {
    return dispatch(orderFail(error.response.data.message));
  }
